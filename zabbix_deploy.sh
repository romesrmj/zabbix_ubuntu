...
toilet -w 100 -f smmono9 ZABBIX PLAYER | lolcat
...
apt install zabbix-sql-scripts zabbix-apache-conf  -y

clear
toilet -w 82 -f mini ZABBIX | lolcat
toilet -w 100 -f smmono9 ZABBIX | lolcat
rm /tmp/finish
...
clear
cd /tmp
wget https://raw.githubusercontent.com/romesrmj/zabbix_ubuntu/main/zabbix-datasource
...
snap install gotop
wget https://github.com/romesrmj/zabbix_ubuntu/blob/main/redes_sociais.json
