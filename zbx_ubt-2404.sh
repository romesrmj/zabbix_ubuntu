...
toilet -f standard --gay "Configurando timezone e locale..."
timedatectl set-timezone "America/Sao_Paulo"
locale-gen "pt_BR.UTF-8"
update-locale LANG="pt_BR.UTF-8"

# Instalar pacotes necessários
toilet -f standard --gay "Atualizando sistema e instalando pré-requisitos..."
apt update -y
...
toilet -f standard --gay "Verificando se o banco e o usuário já existem..."
...
toilet -f standard --gay "Criando banco de dados e usuário do Zabbix..."
...
# Instalar Zabbix
toilet -f standard --gay "Instalando Zabbix..."
...
toilet -f standard --gay "Importando esquema inicial para o banco de dados Zabbix..."
...
toilet -f standard --gay "Atualizando configuração do Zabbix..."
...
toilet -f standard --gay "Reiniciando serviços do MySQL..."
systemctl restart mysql || { echo "Erro ao reiniciar o MySQL"; exit 1; }

# Reiniciar Zabbix
toilet -f standard --gay "Reiniciando serviços do Zabbix..."
...
toilet -f standard --gay "Instalando Grafana e plugin do Zabbix..."
...
toilet -f standard --gay "Configurando o datasource do Zabbix no Grafana..."
...
toilet -f standard --gay "Redefinindo senha do usuário Zabbix..."
...
toilet -f standard --gay "Concedendo permissões ao usuário Zabbix..."
...
echo "$########################################################################$"
toilet -f standard --gay "Instalação do Zabbix e Grafana concluída com sucesso."
echo "Acesse o Zabbix na URL: http://$SERVER_IP/zabbix"
echo "Acesse o Grafana na URL: http://$SERVER_IP:3000"
echo "Usuário padrão do Grafana: admin"
echo "Senha padrão do Grafana: admin"
echo "$########################################################################$"
